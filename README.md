...
docker cp electric-eel-build:/home/mersdk/app/RPMS/harbour-electric-eel-0.2.6-1.aarch64.rpm app/RPMS/
...
```sh
scp app/RPMS/harbour-electric-eel-0.2.6-1.aarch64.rpm defaultuser@<phone-ip>:~/
ssh defaultuser@<phone-ip>
devel-su pkcon install-local ~/harbour-electric-eel-0.2.6-1.aarch64.rpm
```
